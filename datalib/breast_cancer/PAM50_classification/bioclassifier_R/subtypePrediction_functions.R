...
myplot<-function(y,short,pro){
	...
	y$prediction<-factor(y$prediction,levels=c("Basal","Her2","LumA","LumB","Normal-like"))
	...
	boxplot(y$distances[,5]~y$prediction,border=8,ylab="Normal-like Correlation",main=paste(short,": Normal-like",sep=""))
